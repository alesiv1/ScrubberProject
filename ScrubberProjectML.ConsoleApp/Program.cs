...
namespace ScrubberProjectML.ConsoleApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Using model to make single prediction -- Comparing actual Like with predicted Like from sample data...\n\n");
            ...
            Console.WriteLine($"NumberOfViews: {sampleData.NumberOfViews}");
            Console.WriteLine($"\n\nActual Like: {sampleData.Like} \nPredicted Like: {predictionResult.Prediction}\n\n");
